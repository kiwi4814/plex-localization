...
def loopThroughAllItems(plex, logger, day, section):
    ...
    if section.type in ('movie','show'):
        ...
        for item in section.all():
            ...
            if updated_date >= olddate:
                ...
                if check_contain_chinese(item.titleSort):
                    ...
                    titleSort = pinyin + " " + first_letter + " " + word_pinyin + " " + word_first_letter
                ...
                if section.type == 'show':
                    ...
                    for episode in item.episodes():
                        if check_contain_chinese(episode.titleSort):
                            ...
                            word_first_letter = chinese_to_pinyin_first_letter(split_words)
                            titleSort = pinyin + " " + first_letter + " " + word_pinyin + " " + word_first_letter
                            episode.editSortTitle(titleSort, True)
        ...
        for collection in section.collections():     
            ...
            if collection.content == None and check_contain_chinese(collection.titleSort):
                    ...
                    if check_contain_japanese(artist.title):                 
                        ...
                        if check_contain_chinese(artist.title):
                            if check_contain_chinese(artist.titleSort):
                                ...
                                # 优化艺术家名称索引
                                titleSort = chinese_to_pinyin(artist.title) + " " + chinese_to_pinyin_first_letter(artist.title)
                        ...
                        if check_contain_japanese(album.title):                 
                            ...
                            if check_contain_chinese(album.title):
                                if check_contain_chinese(album.titleSort):
                                    ...
                                    # 优化专辑名称索引
                                    titleSort = chinese_to_pinyin(album.title) + " " + chinese_to_pinyin_first_letter(album.title)
